...
View.prototype.exercise0 = function () {
  ...
  //Result: this should cause the grid to turn into a long list of undecorated li's
  //just a list of dots
...
View.prototype.exercise4 = function () {
  ...
  $(".square:nth-child(even)").text("Philippe");
};
...
View.prototype.exercise5 = function () {
  ...
  $('.square').on("click", function(x) {
    const $sq = $(x.currentTarget);
...
View.prototype.exercise7 = function(){
  ...
  $('#easel').on("mouseenter", ".square", function(x) {
    const $sqr = $(x.currentTarget);
